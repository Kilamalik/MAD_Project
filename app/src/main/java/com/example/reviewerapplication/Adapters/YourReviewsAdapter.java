package com.example.reviewerapplication.Adapters;
...
public class YourReviewsAdapter extends RecyclerView.Adapter<YourReviewsAdapter.YourReviewsViewHolder> {
    ...
    DatabaseReference database = FirebaseDatabase.getInstance("https://reviewerapplication-185f7-default-rtdb.firebaseio.com/").getReference("Items");
    DatabaseReference updatedDatabase = FirebaseDatabase.getInstance("https://reviewerapplication-185f7-default-rtdb.firebaseio.com/").getReference("Reviews");
