...
import com.example.reviewerapplication.Review;
...
//        usernames=root.findViewById(R.id.usernames);
       // no_of_favorites=root.findViewById(R.id.no_of_favorites);
        ...
        add_reviwes=root.findViewById(R.id.searchButton);
        add_favorites=root.findViewById(R.id.viewButton);
        ...
        add_reviwes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(add_reviwes.getContext(), Review.class);
                startActivity(intent);
            }
        });
